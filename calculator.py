...
tombol_koma = Button(window, text=",", padx=41, pady=20, command=lambda: tombol_klik("."))

tombol_tambah = Button(window, text="+", padx=39, pady=10, command=lambda: tombol_operasi("+"))
tombol_kurang = Button(window, text=" -", padx=40, pady=10, command=lambda: tombol_operasi("-"))
tombol_kali = Button(window, text="x", padx=40, pady=10, command=lambda: tombol_operasi("*"))
tombol_bagi = Button(window, text=":", padx=42, pady=10, command=lambda: tombol_operasi("/"))
tombol_hapus = Button(window, text="del", padx=35, pady=20, command=tombol_del)
tombol_clear = Button(window, text="DA", padx=35, pady=20, command=tombol_DA)
